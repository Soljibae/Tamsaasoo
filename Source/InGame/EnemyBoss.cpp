...
namespace InGame
{
	void EnemyBoss::Init()
	{
		...
		FrameTime = 1.0f;
		bossApearTime = 0.f;
		Manager::SFXManager.AddNewSFX(SFX, "Assets/SFX/Boss/KnifeThrow.wav", "BossAttackKnife");
		Manager::SFXManager.AddNewSFX(SFX, "Assets/SFX/Boss/FireMagic.wav", "BossAttackMagic");
	}
